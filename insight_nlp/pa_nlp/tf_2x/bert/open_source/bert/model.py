...
from pa_nlp.tf_2x.bert.open_source.bert.embeddings import BertEmbeddingsLayer
from pa_nlp.tf_2x.bert.open_source.bert.transformer import TransformerEncoderLayer
